// Fixed sample values for the formats page and the demo. Constants keep server and
// browser output identical and let the tests compute the expected text per locale.
