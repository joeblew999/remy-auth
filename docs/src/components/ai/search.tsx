...
// Adapted: the chat route is the site's and language's (/api/chat/<site>?lang=es), passed by the layout.
export function AISearch({ children, api = '/api/chat' }: { children: ReactNode; api?: string }) {
