...
`DEPLOY_ORIGIN`, definido en [mise.toml](../mise.toml), y solo se ejecuta a petición del propietario.
...
un archivo por espacio de nombres de tarea; `mise.toml` lo incluye, y [tasks/README.md](../tasks/README.md) explica
...
`mise run skills:list` muestra lo que está instalado; [el plan de skills](../.plans/done/agent-skills.md)
