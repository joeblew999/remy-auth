...
[GUI plan](gui.md); the [development principles](../../docs/content/dev/development.md) apply.
...
(`tasks/project.toml` and `cf.toml`: setup, typecheck, dev, build, preview, test, verify, deploy) is
