...
/** A titled card of label/value rows on the formats page; other props (data attributes) go on the card. */
export function Group({ title, children, ...rest }: { title: string; children: React.ReactNode } & Record<string, unknown>) {
